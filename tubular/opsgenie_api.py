...
class OpsGenieAPI:
    ...
    def alert_opsgenie(self, message, description, team_id):
        """
        ...
        Arguments:
            ...
            team_id: The id of the team that should recieve alert notifications
        """
        ...
        alert_data = {
            ...
            'responders': [{"name": team_id, "type": "team"}],
        }
