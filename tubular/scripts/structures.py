...
@click.pass_context
def make_plan(ctx, plan_file, details, retain, delay, batch_size, ignore_missing):
    """
    ...
    change_plan = ChangePlan.create(structures_graph, retain, ignore_missing, details)
